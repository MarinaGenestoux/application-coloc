...
export function Register() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 grid lg:grid-cols-2">
      {/* Left — Form */}
      <div className="flex flex-col justify-center bg-white px-6 py-10 sm:px-8 sm:py-12 lg:px-12 lg:py-12">
        <motion.div
        ...
        >
          ...
          <div className="mb-8 sm:mb-10">
            <h2 className="font-display text-2xl sm:text-3xl text-slate-900 mb-2">Créer un compte</h2>
      ...
      <div className="hidden lg:flex relative overflow-hidden">
        <div className="absolute inset-0 bg-linear-to-bl from-accent via-orange-400 to-primary" />
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div className="text-sm text-white/50">Déjà plus de 1000 colocations gérées avec ColocApp</div>
        </div>
      </div>
    </div>
  );
